...
public class Ingresar {
    ...
    public void ingresar(ActionEvent actionEvent) throws IOException {
        ...
        if (u.equals("profe")) {
            if (p.equals("petra")) {
                ...
                try {
                    ...
                    alerta.setContentText("Llama a un tecnico");
                    alerta.showAndWait();
                    Platform.exit();
                }
                ...
                ft.setToValue(1.0);
                ft.play();
                Busca controller = fxmlLoader.<Busca>getController();
                controller.setPalabra();
                controller.setDescripcion();
        ...
        } else if (p.equals("maestra"))
            System.out.println("Siguiente Pantalla");
        else {
            intentos++;
            Alert alerta = new Alert(Alert.AlertType.ERROR);
            alerta.setTitle("Error de Autenticacion");
